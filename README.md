...
- `install`
- `update`, если в источнике версия модуля выше установленной

`update` не переустанавливает модуль с такой же или более старой версией. Для обновления нужно поднять `version` в `module.json` модуля.
