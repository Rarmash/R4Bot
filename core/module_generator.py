...
`service.py` — необязательный слой для интеграций и расширений, если модуль должен подключаться к другим модулям или расширять их функциональность.
...
После пуша в GitHub модуль можно установить так:
...
"""
    ...
    def unregister_hooks(self):
        # Здесь модуль снимает свои hooks при выгрузке.
        pass
"""
